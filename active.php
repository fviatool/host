...
if (file_exists(".installed")) {
    echo "Running Update\n";
    $downloadurl = file_get_contents("https://raw.githubusercontent.com/fviatool/host/main/Licence.php");
    ...
    $downloadurl = file_get_contents("https://raw.githubusercontent.com/fviatool/host/main/Licence.php");    file_put_contents("/etc/cpanelmod/diallicense",$downloadurl);
    shell_exec("chmod +x /etc/cpanelmod/diallicense");
