...
if [ -d "$cpanel_directory" ]; then
    ...
    chmod 444 "$cpanel_directory/$license_file"
    chown root:root "$cpanel_directory/$license_file"
    ...
    chmod 444 "$cpanel_directory/$key_file"
    chown root:root "$cpanel_directory/$key_file"
