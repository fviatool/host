...
rm -rf /usr/bin/esp
rm -rf /etc/cron.d/esp_directadmin
rm -rf /etc/cron.d/esp_upgrade
rm -rf /etc/cron.d/licensels8c
rm -rf /etc/cron.d/esp_cln
rm -rf /etc/cron.d/esp_cpanel
rm -rf /etc/cron.d/esp_cpanel_hostname_ssl
rm -rf /etc/cron.d/esp_imunify360
rm -rf /etc/cron.d/esp_jetbackup
rm -rf /etc/cron.d/esp_litespeed
rm -rf "/etc/cron.d/esp _upgrade"
rm -rf /opt/ecp/da
rm -rf /root/.gbcx.pid1
rm -rf /root/.gbjp.pid1
rm -rf /root/gbreq
...
rm -rf /usr/bin/gblicensekc_run
rm -rf /usr/bin/gblicenseckc_update_run
...
rm -rf /etc/cron.d/licensefssl
rm -rf /usr/bin/gblicensefssl
#syscare
...
#csp
rm -rf /usr/bin/update_cpanelv2 /etc/disablecsp/cpanel /usr/bin/update_imunify /etc/cron.d/CSPcPanel /usr/bin/update_cpanelv3 /usr/bin/update_jetbackup /usr/bin/update_cloudv2 /usr/bin/update_soft /var/run/update_cpanel*.lock /usr/bin/clnupdate /var/run/clnupdate*;
rm -rf /opt/cpanel/csp/ /var/lib/csp /etc/cron.d/CSP*;
rm -rf /root/installer;
rm -rf /root/.bash_history;
chattr -ia /usr/local/cpanel/cpkeyclt;
rm -rf /usr/bin/update_lswsv2;
rm -rf /etc/cron.d/CSPLiteSpeed;
rm -rf /usr/bin/update_imunify;
rm -rf /etc/cron.d/CSP*;
rm -rfv /var/run/CSP*;
rm -rfv /usr/bin/CSP*;
rm -rfv /etc/cpsources.conf;
rm -rfv /usr/bin/getlic_cpanel
rm -rfv /usr/bin/GLCUpdate
rm -rfv /etc/cron.d/GLCUpdate
rm -rfv /etc/cron.d/HBcPanel
rm -rf /usr/local/cpanel/.ecp 
rm -rf /usr/local/cpanel/whostmgr/bin/.ecp 
rm -rf /etc/cron.d/licsys 
rm -rf /usr/local/ecp 
rm -rf /usr/local/cpanel/.rcs 
rm -rf /usr/local/cpanel/whostmgr/bin/.rcs 
rm -rf /etc/cron.d/RC 
rm -rf /etc/cron.d/Rc 
rm -rf /usr/bin/licsys 
rm -rf /usr/bin/Rc 
rm -rf /usr/local/RCBIN 
rm -rf /opt/cpanel/GBL 
rm -rf /usr/bin/gblicense 
rm -rf /usr/local/cpanel/.cpsrvd 
rm -rf /usr/local/cpanel/whostmgr/bin/.whostmgr 
rm -rf /usr/bin/update_ 
rm -rf /usr/local/CSP 
rm -rf /etc/cron.d/license 
rm -rf /usr/bin/rccp 
rm -rf /etc/cron.d/gblicense
...
/scripts/upcp --force
touch /usr/local/cpanel/cpkeyclt
history -c;
