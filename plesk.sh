...
update_os_components_deb()
{
	...
	# icu-devtools is for autoinstaller: libicu66 on Ubuntu 20.04, libicu72 on Debian 12, libicu60 on Ubuntu 18.04, libicu67 on Debian 11, libicu63 on Debian 10
